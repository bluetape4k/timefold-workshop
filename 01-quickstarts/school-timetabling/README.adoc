= 학교 시간표 작성 (Kotlin, Quarkus, Maven)

수업을 시간대와 강의실에 배정하여 교사와 학생을 위한 더 나은 시간표를
생성합니다.
...
. https://sdkman.io[Sdkman]을 사용하여 JDK, Maven, Kotlin을 설치합니다.
+
----
$ sdk install java
$ sdk install maven
...
[NOTE]
====
Kotlin으로 작성했지만 `java` 명령으로 실행할 수 있습니다.
====
+
[NOTE]
====
