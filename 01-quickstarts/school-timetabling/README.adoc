= 학교 시간표 작성 (Kotlin, Spring WebFlux, Gradle)
...
기본 주소는 http://localhost:8080입니다. 데모 문제를 조회한 뒤
...
* https://docs.timefold.ai/timefold-solver/latest/running-timefold-solver/library/spring-boot[Spring Boot integration]
