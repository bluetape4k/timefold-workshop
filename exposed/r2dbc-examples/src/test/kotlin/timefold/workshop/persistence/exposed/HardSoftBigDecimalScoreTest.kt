...
import io.bluetape4k.timefold.solver.exposed.api.score.buildin.hardSoftBigDecimalScore
...
class HardSoftBigDecimalScoreTest: AbstractScoreExposedTest() {
    ...
    fun `HardSoftBigDecimalScore 를 DB 에 저장 및 조회하기`(testDB: TestDB) = runSuspendIO {
