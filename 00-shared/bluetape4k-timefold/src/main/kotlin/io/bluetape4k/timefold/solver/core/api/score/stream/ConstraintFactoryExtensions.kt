...
inline fun <reified T> ConstraintFactory.forEach(): UniConstraintStream<T> =
    forEach(T::class.java)

inline fun <reified T> ConstraintFactory.forEachIncludingUnassigned(): UniConstraintStream<T> =
    forEachIncludingUnassigned(T::class.java)

inline fun <reified T> ConstraintFactory.forEachUniquePair(): BiConstraintStream<T, T> =
    forEachUniquePair(T::class.java)

inline fun <reified T> ConstraintFactory.forEachUniquePair(
    joiner: BiJoiner<T, T>,
